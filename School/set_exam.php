...
<html>
	...
	<body>
			...
			<img src="https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX24504100.jpg" style="margin-left:90px;" class="sha">
				...
				<div class="content">
					...
					<div class="lbox">
						<label> Exam Name</label><br>
							<input type="text" class="input3" name="ename" autocomplete="off"><br><br>
