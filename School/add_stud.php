			...
			<div id="section">
				...
				<div class="lbox">
					<label> ID</label><br>
						...
						?>
					<input type="text" class="input3" name="rno" style="background:#b1b1b1;" value="<?php echo $no;?>" readonly   autocomplete="off"><br><br>
					<label> Student Name</label><br>
					<input type="text" class="input3" name="name"  autocomplete="off"><br><br>
					<label> Father Name</label><br>
					<input type="text" class="input3" name="fname"  autocomplete="off"><br><br>
					...
					<input type="text" class="input3" maxlength="10" name="pho"  autocomplete="off"><br><br>
				</div>
				
				<div class="rbox">
				
				<label> Parent's Mail Id</label><br>
					<input type="email" class="input3" name="email"  autocomplete="off"><br><br>
