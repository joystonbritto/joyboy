			...
			<div id="section">
				...
				<div class="content">
					...
					<form  enctype="multipart/form-data" role="form"  method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
							...
							<input type="text" maxlength="10" required class="input3" name="pno"  autocomplete="off"><br><br>
							<label>  E - Mail</label><br>
							<input type="email"  class="input3" required name="mail"  autocomplete="off"><br><br>
